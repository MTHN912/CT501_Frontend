  ...
  methods: {
    ...
    async submitUpdateOrder() {
      try {
        ...
        await axios.patch(
          `http://localhost:3000/order/ordersPackage/${this.selectedOrder._id}/status`,
          {
    ...
    async updatePartyStatus(newStatus) {
      try {
        ...
        await axios.patch(
          `http://localhost:3000/order/ordersPackage/${this.selectedOrder._id}/party-status`,
          {
    ...
    async confirmOrder() {
      try {
        const response = await axios.put(
          `http://localhost:3000/order/odersPackage/${this.selectedOrder._id}/confirm`,
          {}
        );
